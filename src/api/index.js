...
export default {
  ...
  deleteFavoriteRecipe: (sid, rec_id) => axios.delete('favorites', { params: { sid, rec_id } }),
  postIngredient: (sid, ing_name) => axios.post('ingredients', null, { params: { sid, ing_name } }),
  ...
  adminUpdateUserRole: (data) =>
    axios.put('admin/give-role', null, {
      params: {
        usr_id: data.usr_id,
